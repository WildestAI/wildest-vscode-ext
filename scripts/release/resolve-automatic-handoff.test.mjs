...
test('selects the highest final immutable release newer than the extension', () => {
  const selected = selectAutomaticHandoff([
    { tag_name: 'cli-v1.0.7-a1b2c3d4e5f6', draft: false, prerelease: false },
    { tag_name: 'cli-v1.0.8-a1b2c3d4e5f6', draft: false, prerelease: true },
    { tag_name: 'cli-v1.1.0-a1b2c3d4e5f6', draft: true, prerelease: false },
    { tag_name: 'cli-v1.0.6-a1b2c3d4e5f6', draft: false, prerelease: false },
  ], '1.0.5');
...
test('skips when no final immutable release would advance the extension', () => {
  assert.equal(selectAutomaticHandoff([
    { tag_name: 'cli-v1.0.5-a1b2c3d4e5f6', draft: false, prerelease: false },
    { tag_name: 'cli-v1.0.6-a1b2c3d4e5f', draft: false, prerelease: false },
  ], '1.0.5'), undefined);
});
